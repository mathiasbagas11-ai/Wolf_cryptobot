...
laptop, or CI. Only messages from allowed chats are honoured. Network and decode
errors are caught and backed off — a Telegram hiccup must never kill the thread.
"""
